...
export default function Planner() {
  ...
  if (!isLoaded) {
    return (
      <div className="flex h-screen items-center justify-center bg-[#F8F9FA] dark:bg-black">
  ...
  return (
    <div className="min-h-screen pb-28 md:pb-6 md:pt-6 max-w-[400px] mx-auto relative bg-[#F8F9FA] dark:bg-black md:bg-white dark:md:bg-[#0A0A0A] md:shadow-2xl md:border-[8px] md:border-neutral-900 dark:md:border-neutral-800 md:rounded-[48px] overflow-hidden md:h-[800px] md:min-h-0 md:my-auto flex flex-col transition-colors duration-300">
      ...
      {/* FAB */}
      <div className="fixed bottom-0 left-0 right-0 p-6 md:absolute md:bottom-0 z-30 bg-gradient-to-t from-[#F8F9FA] via-[#F8F9FA] dark:from-black dark:via-black to-transparent md:from-white md:via-white dark:md:from-[#0A0A0A] dark:md:via-[#0A0A0A]">
        <button
          onClick={handleOpenSheet}
          className="w-full bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 py-4 rounded-2xl font-semibold flex items-center justify-center gap-2 active:scale-[0.98] transition-all"
        >
